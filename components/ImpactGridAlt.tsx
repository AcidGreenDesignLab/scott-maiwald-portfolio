  ...
  return (
    <div className="relative w-full">
      <motion.div
        ...
        className={`relative flex flex-col ${index % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12 md:gap-20 transition-all duration-300 group`}
      >
...
export default function ImpactGridAlt({ projects }: { projects: Project[] }) {
  const ref = useRef<HTMLDivElement>(null);
        ...
        <div className="flex flex-col">
          {projects.map((p, i) => (
            <div key={p.id} className="flex flex-col">
              {i > 0 && <div className="w-full h-px bg-white/5 my-16" />}
