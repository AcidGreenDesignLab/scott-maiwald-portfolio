...
function ImageStrip({
  ...
  if (!images || images.length === 0) {
    return (
      <div className="relative w-full aspect-[16/10] bg-slate-950 flex flex-col items-center justify-center border-b border-white/10 shrink-0">
  ...
  return (
    <div 
      className="relative w-full aspect-[16/10] bg-slate-900 border-b border-white/10 shrink-0 cursor-pointer"
...
function ProjectCard({
  ...
  return (
    <>
      ...
      className="relative rounded-2xl flex flex-col cursor-default transition-all duration-300 card-glass group overflow-hidden"
      style={{
        borderColor: hovered
          ? `${project.accent}40`
...
export default function ImpactGrid({ projects }: { projects: Project[] }) {
  const ref = useRef<HTMLDivElement>(null);
